...
export default function RegisterAgree(props) {
    const agreementText = `개인정보보호법에 따라 DIY에 회원가입 신청하시는 분께 수집하는 개인정보의 항목, 개인정보의 수집 및 이용목적, 개인정보의 보유 및 이용기간, 동의 거부권 및 동의 거부 시 불이익에 관한 사항을 안내 드리오니 자세히 읽은 후 동의하여 주시기 바랍니다.
    ...
    return (
        <div className="flex justify-center items-center mt-10 w-screen">
            <div className="flex flex-col justify-center items-center bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4 sm:w-4/6 lg:w-3/5">
                ...
                <textarea
                    className="form-textarea w-full h-96 mb-8"
                    value={agreementText}
                    readOnly
                />
                ...
                <div className="mb-4">
                    <input
                        ...
                        name="agreeYn"
                        value="Y"
                        onChange={onAgreeYnHandler}
                    />
                    <label className="mr-6" htmlFor="agreeY">
                        동의합니다.
                    </label>
                    <input
                        className="form-radio mr-1"
